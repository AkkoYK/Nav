...
2. Ai搜索：支持一步直达（快捷键：长按 Enter） YKload 旗下的 [求索QiuSeek](https://qs.ykload.com) 进行高效Ai搜索。
3. 动态背景：支持风景（[Bing 日图](https://api.dujin.org/bing/1920.php)）和萌图（[栗次元API](https://t.alcy.cc)）两种背景选项。
4. 联想弹幕：提供搜索联想功能，并以弹幕形式展示。
5. 时间显示：实时显示当前时间和日期。
